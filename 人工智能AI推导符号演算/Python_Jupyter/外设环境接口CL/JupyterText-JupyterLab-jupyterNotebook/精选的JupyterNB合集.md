...
数据分析为什么常用Jupyter而不是直接使用Python脚本或Excel? - Charles Wang的回答 - 知乎
https://www.zhihu.com/question/37490497/answer/125536948




1.[XKCD plots in Matplotlib](http://nbviewer.jupyter.org/url/jakevdp.github.com/downloads/notebooks/XKCD_plots.ipynb)  
**仿制XKCD式手写图标**
...
2.[Introduction to Computer Science with Python as Tel-Aviv University](https://github.com/yoavram/CS1001.py)  
3.[Introduction to Python](http://nbviewer.jupyter.org/github/ehmatthes/intro_programming/blob/master/notebooks/index.ipynb)  
4.[Exploratory computing with Python by Mark Bakker](http://mbakker7.github.io/exploratory_computing_with_python/)

  

**数据分析机器学习篇**

5.[Neural Networks](http://nbviewer.jupyter.org/github/masinoa/machine_learning/blob/master/04_Neural_Networks.ipynb)  
**机器学习人工神经网络模型**

6.[Map-Reduce and Apache Spark](http://nbviewer.jupyter.org/github/phelps-sg/python-bigdata/blob/master/src/main/ipynb/spark-mapreduce.ipynb)  
**大规模并行计算框架Spark教程**

7.[Analysing structured data using pandas](http://nbviewer.jupyter.org/github/phelps-sg/python-bigdata/blob/master/src/main/ipynb/pandas.ipynb)  
**表格数据处理库Pandas教程**

9.[Automating Microsoft Office with Python](http://nbviewer.jupyter.org/github/sanand0/ipython-notebooks/blob/master/Office.ipynb)  
...
11.  
[CBE20255 by jckantor](http://jckantor.github.io/CBE20255/)  
**化学工程分析入门（圣母大学本科课程）**

12.  
[Working with Reactions](http://nbviewer.jupyter.org/gist/greglandrum/4316430)  
**化学反应模拟器**
...
14.  
[Color Science for Python](http://nbviewer.jupyter.org/github/colour-science/colour-ipython/blob/master/notebooks/colour.ipynb)  
**色彩学入门**

15.  
[Population Genetics in an RNA World](http://nbviewer.jupyter.org/github/gocarli/RNA-Popgen-Notebook/blob/master/Population_Genetics.ipynb)  
**RNA种群遗传学**
...
16.  
[Estimated likelihood of observing a large earthquake on a continental low‐angle normal fault and implications for low‐angle normal fault activity](http://nbviewer.jupyter.org/github/cossatot/lanf_earthquake_likelihood/blob/master/notebooks/lanf_manuscript_notebook.ipynb)  
**大陆板块低斜率断层对地震的预测**  
*（大概是这么翻译的吧...？）*

17.  
[NLTK, maps, and 007](https://ocefpaf.github.io/python4oceanographers/blog/2015/10/26/007/)  
**007原著小说中詹姆斯邦德杀人地点的可视化**

  

18.  
[Iris "Hidden" Features](https://ocefpaf.github.io/python4oceanographers/blog/2015/09/07/iris_outline/)  
...
20.  
[Exercise to detect Algorithmically Generated Domain Names](http://nbviewer.jupyter.org/github/ClickSecurity/data_hacking/blob/master/dga_detection/DGA_Domain_Detection.ipynb)  
**机器生成域名的识别与分析**

  

21.  
[Mining Twitter: Exploring Trending Topics, Discovering What People Are Talking About, and More](https://rawgit.com/ptwobrussell/Mining-the-Social-Web-2nd-Edition/master/ipynb/html/Chapter%201%20-%20Mining%20Twitter.html)  
**文字信息挖掘与分析 \- Twitter热门话题**

22.  
[Mining Facebook: Analyzing Fan Pages, Examining Friendships, and More](https://rawgit.com/ptwobrussell/Mining-the-Social-Web-2nd-Edition/master/ipynb/html/Chapter%202%20-%20Mining%20Facebook.html)  
**文字信息挖掘与分析 \- Facebook粉丝页面，朋友关系**

23.  
[Mining LinkedIn: Faceting Job Titles, Clustering Colleagues, and More](https://rawgit.com/ptwobrussell/Mining-the-Social-Web-2nd-Edition/master/ipynb/html/Chapter%203%20-%20Mining%20LinkedIn.html)  
**文字信息挖掘与分析 \- LinkedIn职称，同事分组**

  

24.  
[Mining Google+: Computing Document Similarity, Extracting Collocations, and More](https://rawgit.com/ptwobrussell/Mining-the-Social-Web-2nd-Edition/master/ipynb/html/Chapter%204%20-%20Mining%20Google+.html)  
**文字信息挖掘与分析 \- Google+文章相似性，词组提取**

  

25.  
[Mining GitHub: Inspecting Software Collaboration Habits, Building Interest Graphs, and More](https://rawgit.com/ptwobrussell/Mining-the-Social-Web-2nd-Edition/master/ipynb/html/Chapter%207%20-%20Mining%20GitHub.html)  
...
26.  
[Presentation Materials for my "Sound Analysis with the Fourier Transform and Python" OSCON Talk.](https://github.com/calebmadrigal/FourierTalkOSCON)  
**对声波的傅里叶变换**
...
29.  
[Lecture notes for the masters course Digital Signal Processing](https://github.com/spatialaudio/digital-signal-processing-lecture)  
**电子信号处理（完整的硕士课程）**
