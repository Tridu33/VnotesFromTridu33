...
如果有父类，加载顺序是：父类static方法 –> 子类static方法 –> 父类构造方法- -> 子类构造方法 。
...
[Java常用基础知识点总结（最全）](https://blog.csdn.net/liuerchong/article/details/107751054)

![format,png](_v_images/20210515232921418_182.png)
