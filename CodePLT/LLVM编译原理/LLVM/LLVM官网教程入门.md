...
本教程分为几章，涵盖各个主题，使您可以随意跳过：第1章：万花筒语言和Lexer-显示了我们要去的地方和要构建的基本功能。  
...
## Kaleidoscope: Implementing a Language with LLVM[](http://llvm.org/docs/tutorial/index.html#kaleidoscope-implementing-a-language-with-llvm "Permalink to this headline")
...
## Kaleidoscope: Implementing a Language with LLVM in Objective Caml[](http://llvm.org/docs/tutorial/index.html#kaleidoscope-implementing-a-language-with-llvm-in-objective-caml "Permalink to this headline")
...
## Building a JIT in LLVM[](http://llvm.org/docs/tutorial/index.html#building-a-jit-in-llvm "Permalink to this headline")
...
## External Tutorials[](http://llvm.org/docs/tutorial/index.html#external-tutorials "Permalink to this headline")
...
## Advanced Topics[](http://llvm.org/docs/tutorial/index.html#advanced-topics "Permalink to this headline")
