...
[多伦多大学golog的prolog解析器s](http://www.cs.toronto.edu/cogrobo/main/systems/index.html)


https://github.com/ssardina-agts/indigolog


[多伦多大学golog的prolog解析器](http://www.cs.toronto.edu/cogrobo/Systems/golog_swi.pl)
...
there exist(s) (a) **Prolog interpreter**(s) for Golog

Golog interpreter uses Prolog

Prolog interpreter(s) for Golog


原来Golog就是从plan规划问题到program的一种实现
...
IndiGolog(Incremental Deterministic Golog) is a successor of Golog
still based on Situation Calculus
IndiGolog Interpreter---basically implemented in Prolog
...
Giuseppe Giacomo, Yves Lespérance, Hector J. Levesque and Sebastian Sardina:  IndiGolog: A High-Level Sebastian Sardina:  **IndiGolog**: A High-Level Programming Language for Embedded Reasoning Agents, Multi-Agent Programming,  Springer, 2009.Agents, MultiAgent Programming,  Springer, 2009
